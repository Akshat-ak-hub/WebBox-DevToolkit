...
<p align="center">
  <img src="devbox/public/icons/icon128.png" alt="DevBox Logo" width="110" height="110" />
</p>
...
3. **Build the extension package:**
   ...
   npm run build
   ```
   *This compiles TypeScript, bundles React with Vite and CRXJS, and creates the ready-to-use extension in the `devbox/dist` folder.*
...
5. In the file picker dialog, navigate to the project directory and select the **`dist`** folder (located inside `devbox/dist`).
...
4. Select the `devbox/dist` folder.
</details>
...
3. Click **Load unpacked** and select the `devbox/dist` folder.
</details>
